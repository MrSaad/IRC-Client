...
// 	char input[512];
// 	char newUsers[] = "person1 person2 123456789";
// 	int debug=0;
...
// 	//draw test
// 	if(debug) printDebugMessage(&wc, "debugging ready");
// 	printEnterMessage(&wc, "saad");
// 	printLeaveMessage(&wc, "saad", "fdsfasd");
// 	printErrorMessage(&wc, "you dun goof'd");
// 	printWarningMessage(&wc, "careful..");
	
// 	populateUsers(&wc, newUsers);
// 	printEnterMessage(&wc, "1234567899");
// 	printEnterMessage(&wc, "1234567898");
// 	printServerMessage(&wc, "welcome to da lobby");

// 	while(1){
// 		getInput(&wc, input);
// 		// if(!strcmp(input, "leave")) printMessage(&wc, "leaving", NULL);
// 		if(!strcmp(input, "exit")) break;
// 		// else if(strlen(input)==4) printLeaveMessage(&wc, input);
// 		else if(!strcmp(input, "nick")) printNickChangeMessage(&wc, "1234567899", "saad");
// 		else if(!strcmp(input, "change")) {updateChannel(&wc, "new channel");}
// 		else if(!strcmp(input, "changetopic")) {updateTopic(&wc, "motha effin topic");}
// 		else if(strlen(input)!=0) printMessage(&wc, input, "1234567899");
// 	}
